...
<div id="my-events-page" data-base-url="<?= htmlspecialchars($cfg_base_url) ?>">
    ...
    <section class="home-pane active" data-nhom="sap_toi">
      ...
      if (empty($ds1)) echo '<p class="nho">Chưa có sự kiện.</p>'; ?>
        </div>
    ...
    <section class="home-pane" data-nhom="dang_dien_ra">
      ...
      if (empty($ds2)) echo '<p class="nho">Chưa có sự kiện.</p>'; ?>
        </div>
    ...
    <section class="home-pane" data-nhom="da_ket_thuc">
      ...
      if (empty($ds3)) echo '<p class="nho">Chưa có sự kiện.</p>'; ?>
        </div>
...
document.addEventListener('click', function(e) {
    ...
    if (t) {
        ...
        document.querySelectorAll('.home-pane').forEach(p => p.classList.toggle('active', p.dataset.nhom ===
            nhom));
    }
