...
$stmC->bindValue(':now', $now);
$stmD->bindValue(':now', $now);
$stmD->bindValue(':lim', $per_page, PDO::PARAM_INT);
$stmD->bindValue(':off', $offset, PDO::PARAM_INT);
$stmC->execute();
$tong = (int)$stmC->fetchColumn();
$stmD->execute();
$rows = $stmD->fetchAll(PDO::FETCH_ASSOC);
