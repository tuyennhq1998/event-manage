...
<form id="form-cai-dat" class="the" action="<?= htmlspecialchars($base) ?>/admin/tab_cai_dat.php?ajax=1" method="post"
    ...
    <div class="form-nhom">
        ...
        <div class="hang" style="gap:12px;align-items:flex-start">
            ...
            <img id="xem-logo" src="<?= htmlspecialchars($logo) ?>" alt="Logo"
        ...
        <div class="hang" style="gap:12px;align-items:flex-start;flex-direction:column">
            ...
            <div id="banner-list" style="display:flex;gap:8px;flex-wrap:wrap">
                ...
                <div class="banner-item" style="position:relative;">
                    <img src="<?= htmlspecialchars(trim($bannerUrl)) ?>"
                        data-url="<?= htmlspecialchars(trim($bannerUrl)) ?>" alt="Banner"
                        style="max-height:120px;border:1px solid #e5e7eb;padding:4px;border-radius:8px;background:#fff">
  ...
  })(this);" style="position:absolute;top:-5px;right:-5px;background:red;color:white;border:none;border-radius:50%;width:20px;height:20px;cursor:pointer;font-size:12px">×</button>
                </div>
                <?php endif; ?>
                <?php endforeach; ?>
            </div>
