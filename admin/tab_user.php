    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a class="nut"
                        href="<?= $base ?>/admin/user_quan_ly.php?hanh_dong=form_sua&id=<?= $u['id'] ?>">✏️</a>
                    <a class="nut" onclick="return confirm('Xóa user này? Hành động không thể hoàn tác.')"
                        href="<?= $base ?>/admin/user_quan_ly.php?hanh_dong=xoa&id=<?= $u['id'] ?>">🗑️</a>
                </td>
            </tr>
            <?php endforeach; ?>
            <?php if (empty($ds)): ?>
