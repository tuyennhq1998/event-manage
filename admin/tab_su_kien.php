  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?= htmlspecialchars($sk['thoi_gian_bat_dau']) ?> → <?= htmlspecialchars($sk['thoi_gian_ket_thuc']) ?></td>
        <td><?= htmlspecialchars($sk['dia_diem']) ?></td>
        <td>
          <a class="nut" href="<?= $base ?>/admin/sukien_quan_ly.php?hanh_dong=form_sua&id=<?= $sk['id'] ?>">✏️</a>
          <a class="nut" onclick="return confirm('Xóa sự kiện này?')" href="<?= $base ?>/admin/sukien_quan_ly.php?hanh_dong=xoa&id=<?= $sk['id'] ?>">🗑️</a>
